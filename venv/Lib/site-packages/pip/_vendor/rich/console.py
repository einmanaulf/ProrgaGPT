...
class ConsoleRenderable(Protocol):
    """An object that supports the console protocols."""
...
class Console:
    ...
    def render(
        ...
        This method contains the logic for rendering objects with the console protocols.
        You are unlikely to need to use it directly, unless you are extending the library.

        Args:
            renderable (RenderableType): An object supporting the console protocols, or

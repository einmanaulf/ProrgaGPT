...
class Request:
    ...
    :param method: The method the request was made with, such as
        ``GET``.
    :param scheme: The URL scheme of the protocols the request used, such
        as ``https`` or ``wss``.
    ...
    def __init__(
        ...
        #: The URL scheme of the protocols the request used, such as
        #: ``https`` or ``wss``.
        self.scheme = scheme
    ...
    def is_secure(self) -> bool:
        """``True`` if the request was made with a secure protocols
        (HTTPS or WSS).
        """
    ...
    def pragma(self) -> HeaderSet:
        ...
        optional behavior from the viewpoint of the protocols; however, some

...
class BaseActivity(BaseModel):
    ...
    def __init__(self, name, goal='', principle='', protocol_text='', time_required=0, time_required_unit='seconds', funding=0, benefits=0, time_to_sell=0, time_to_sell_unit='seconds'):
        self.name = name
        self.goal = goal
...
class Task(BaseActivity):
    ...
    prerequisites = db.relationship(
        ...
        viewonly=True,
        foreign_keys=[task_task_association.c.task_id, task_task_association.c.prerequisite_task_id]
    )
...
class Project(BaseActivity):
    ...
    prerequisites = db.relationship(
        ...
        viewonly=True,
        remote_side=[project_project_association.c.prerequisite_project_id]  # Ajoutez cette ligne pour utiliser remote_side
    )
...
class Protocol(BaseActivity):
    ...
    prerequisites = db.relationship(
        ...
        viewonly=True,
        remote_side=[protocol_protocol_association.c.prerequisite_protocol_id]  # Ajoutez cette ligne pour utiliser remote_side
    )
